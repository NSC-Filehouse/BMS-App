...
const translations = {
  de: {
    ...
    push_mandants_title: 'Hauptmandant für Push',
    push_enable_hint: 'Aktiviere zuerst Push auf diesem Gerät. Danach kannst du Push für deinen Hauptmandanten freischalten.',
  ...
  en: {
    ...
    push_mandants_title: 'Primary mandant for push',
    push_enable_hint: 'Enable push on this device first. After that you can enable push for your primary mandant.',
