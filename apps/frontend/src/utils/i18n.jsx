...
const translations = {
  de: {
    ...
    push_not_supported: 'Push Nachrichten werden auf diesem Geraet oder in diesem Browser nicht unterstuetzt.',
    push_permission_granted: 'Push ist fuer dieses Geraet freigegeben.',
    push_permission_denied: 'Push wurde im Browser blockiert. Bitte aktiviere Benachrichtigungen in den Geraet- oder Browser-Einstellungen.',
    ...
    push_mandants_title: 'Mandanten fuer Push',
    push_enable_hint: 'Aktiviere zuerst Push auf diesem Geraet. Danach kannst du die Mandanten einzeln freischalten.',
    push_enabled_success: 'Push wurde auf diesem Geraet aktiviert.',
    push_disabled_success: 'Push wurde auf diesem Geraet deaktiviert.',
