...
const translations = {
  de: {
    ...
    push_enable_hint: 'Aktiviere zuerst Push auf diesem Gerät. Danach kannst du die Mandanten einzeln freischalten.',
  ...
  en: {
    ...
    push_enable_hint: 'Enable push on this device first. After that you can switch mandants on individually.',
